...
class citfact_gravatar extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'citfact.gravatar';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('GRAVATAR_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('GRAVATAR_MODULE_DESCRIPTION');
